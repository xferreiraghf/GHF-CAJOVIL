...
caminho_instant_client = r'C:\Users\b11015\AppData\Local\Temp\2\instantclient_12_2'
...
def executar_importacao():
    def importacao_thread():
        ...
        try:
            ...
            messagebox.showinfo("Importação Concluída", f"Importação concluída com sucesso! {registros_importados_total} linhas foram importadas.")
...
btn_execute = ctk.CTkButton(root, text="Executar", text_color="white", width=200, bg_color="#242424", hover_color="#0eda25", font=("Roboto", 15), command=executar_importacao)
